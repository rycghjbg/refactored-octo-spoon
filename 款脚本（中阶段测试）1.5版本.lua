...
function loadMainScript()
    ...
    sectionCommon:Toggle("自瞄（瞄准头部）", false, function(state) aimEnabled = state; updateFeatureHeartbeat(); Window:Notification("自瞄", state and "已开启" or "已关闭", state and "Success" or "Info", 2) 
end)
    ...
    local KNOCKBACK_THRESHOLD = 80

local antiKnockbackEnabled = false
local antiKnockbackConnection = nil

sectionCommon2:Toggle("防甩飞（无碰撞箱）", false, function(state)
    ...
    sectionCommon2:Button("甩人", function() loadstring(game:HttpGet("https://pastebin.com/raw/zqyDSUWX"))()
end)
    ...
    sectionCommon2:Button("iw指今控制台", function() loadstring(game:HttpGet(('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'),true))()
end)
    
    sectionCommon2:Button("旋转", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/dingding123hhh/tt/main/%E6%97%8B%E8%BD%AC.lua"))()
end)
    
    sectionCommon2:Toggle("反挂机", false, function(state) loadstring(game:HttpGet("https://pastebin.com/raw/9fFu43FF"))() end)
    
    sectionCommon2:Button("工具挂", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Bebo-Mods/BeboScripts/main/StandAwekening.lua"))()
end)
...
sectionFun:Button("阿尔宙斯同款自瞄", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/dingding123hhh/sgbs/main/%E4%B8%81%E4%B8%81%20%E6%B1%89%E5%8C%96%E8%87%AA%E7%9E%84.txt"))()
end)
